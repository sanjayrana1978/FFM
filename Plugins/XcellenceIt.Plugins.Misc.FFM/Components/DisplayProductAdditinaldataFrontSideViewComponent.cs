...
{
    [ViewComponent(Name = DefaultFFMStrings.ProductAdditinalInfoDiaplayFrontSide)]
    public class DisplayProductAdditinaldataFrontSideViewComponent : NopViewComponent
    {
        ...
        public DisplayProductAdditinaldataFrontSideViewComponent(IFFMServices fFMServices,
