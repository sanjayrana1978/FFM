...
{
    public partial record OnePageCheckoutExtendedModel : BaseNopModel
    {
        ...
        public UniversalOnePageCheckoutConfigurationModel OnePageCheckoutConfigurationModel { get; set; }
